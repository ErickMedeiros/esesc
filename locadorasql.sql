...
--
-- Host: 127.0.0.1
-- Generation Time: 10-Out-2016 às 19:53
...
--
-- Estrutura da tabela `alexandresilva`
--

CREATE TABLE `alexandresilva` (
...
--
-- Extraindo dados da tabela `alexandresilva`
--

INSERT INTO `alexandresilva` (`codigo`, `primeiroNome`, `ultimoNome`) VALUES
(4, 'Lindomar ', 'Araújo'),
(7, 'Antonio Andrade', 'Silva'),
(8, 'Antonio Ramos', 'Lucas');
...
(1, 'José de Oliveira Pedro', '885.985.985-98', 'jpedro@nada.com.br', 'Rua das Oliveiras, 1254, Centro, Araripina, P'),
(2, 'Paulo Afonso de Carvalho', '893.095.098-87', 'pcarvalho@ig.com.br', 'Rua da Igreja, SN, Centro, Calumbi-PE');
...
(1, 'O Hobbit', 'Aventura', '3', 'Disponível'),
(2, 'Atirador', 'Ação', '4', 'Locado'),
(3, 'Teste', 'Animação', '4', 'Danificado'),
(4, 'A Caçada', 'Terror', '4', 'Disponível');
...
CREATE TABLE `locacao` (
  `codigo` int(11) NOT NULL,
  `dataLocacao` varchar(10) DEFAULT NULL,
...
(7, '01/05/2016', '02/05/2016', 'O Hobbit', 'José de Oliveira Pedro'),
(9, '09/10/2016', '10/10/2016', 'A Caçada', 'Paulo Afonso de Carvalho');
...
--
-- Indexes for table `alexandresilva`
--
ALTER TABLE `alexandresilva`
...
--
-- AUTO_INCREMENT for table `alexandresilva`
--
ALTER TABLE `alexandresilva`
...
('root', '[{"db":"locadora","table":"alexandresilva"},{"db":"locadora","table":"locacao"},{"db":"locadora","table":"filme"}]');
...
('root', '2016-10-10 02:18:22', '{"lang":"pt","collation_connection":"utf8mb4_general_ci"}');
